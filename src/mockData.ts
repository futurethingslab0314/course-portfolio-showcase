...
export const STUDENT_WORKS: StudentWork[] = [
  ...
  // DB: Everyday Tracking (Grid Expandable Style)
  {
    ...
    members: ['鄭秀芳', '陳玉書'],
    studentIds: ['M11210112', 'M11210113'],
  ...
  // DB: Visual Narratives (Editorial Focus Style)
  {
    ...
    members: ['許立琦', '楊凱雯'],
    studentIds: ['M11210115', 'M11210116'],
